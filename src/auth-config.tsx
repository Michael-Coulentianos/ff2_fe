...
export const msalConfig = {
  auth: {
    ...
    redirectUri: "https://app-farmersfriend-qa.azurewebsites.net//settings", // You must register this URI on Azure Portal/App Registration. Defaults to window.location.origin
    postLogoutRedirectUri: "https://app-farmersfriend-qa.azurewebsites.net/", // Indicates the page to navigate after logout.
